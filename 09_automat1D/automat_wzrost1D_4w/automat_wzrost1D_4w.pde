...
//  (najprostsza symulacja CA w postaci funkcyjnej) 
//-//////////////////////////////////////////////////////////////////////////////////////////
...
int[] World=new int[WorldSize]; //Tworzenie tablicy - w Processingu zawsze za pomocą alokacji
                               ...
                               // - ma swoje metody ;-) i atrybuty dostępne w notacji kropkowej
...
//    World[i]=0;                 //W tej wersji Processingu nie jest 
...
void draw()
{
  ...
  {                              //`length` to atrybut aktualnej długości tablicy 
    if(World[i]>0) stroke(255,World[i],0); //Żółtawy
    else           stroke(0,0,-World[i]); //Niebieski
    point(i,t);                  //Stan automatu w chwili t w t-tej linii okna
  }
