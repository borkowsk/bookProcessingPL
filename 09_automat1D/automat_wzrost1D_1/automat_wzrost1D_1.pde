//Jednowymiarowy, asynchroniczny automat komórkowy - szkielet i najprostsza symulacja w postaci "bez funkcyjnej" 
//-////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
for(int t=0;t<1000;t++) //Ile pokoleń?
{
  ...
  for(int i=0;i<World.length;i++) //Zmiana stanu automatu
    if(random(1.0)>0.75) //Tylko 1/4 komórek zmienia swój stan
    {
       ...
       if(right<WorldSize //O ile prawy indeks jest w tablicy (tablica ma indeksy do WorldSize-1)
