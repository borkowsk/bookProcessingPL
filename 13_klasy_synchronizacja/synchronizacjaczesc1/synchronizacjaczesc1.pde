...
//zdefiniowaliśmy klasę, teraz jej użyjemy, współczynnik spięcia, synchronizacji
//-///////////////////////////////////////////////////////////////////////////////////////

final  float DefaultAlpha=0.1; //dwa systemy od siebie niezależne, wpływając na alfa możemy zwiększać ich wzajemną synchronizacje
final  int   Rozbieg=100;

singiel First, Second; // uchwyty do obiektów, to ze je zadeklarujemy nie oznacza ze istnieją. 
                      // obiekty powstaną dalej, więc uchwyt złapie to co tam powstanie
...
void setup()
{
   ...
   // First=new singiel() // tworzymy nowy obiekt, będzie typu singiel, używamy konstruktor singiel
   First= new singiel(random(1.0), 3.5+random(0.5), DefaultAlpha); // 3,5 do 4 bo synchronizacja w chaosie jest najciekawsza
   ...
   println("2st:",Second.x1+" "+Second.r+" alfa:"+Second.alpha()); //kropka i nazwa pola więc czytamy nazwę pola lub można z funkcją
}
...
void draw()
{
  ...
  {
    N=0; //Zaczynamy od początku z innymi wartościami początkowymi
