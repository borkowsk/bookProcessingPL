...
float h=0;
float x=0;
float vh=150; //prędkość pionowa w pikselach/SEKUNDĘ (!)
float vx=150; //prędkość pozioma
float ah=0;   //Przyśpieszenie/hamowanie - w pionie
float ax=0;   //I w poziomie
float M=0.95; //Wydajność odbicia sprężystego 1-B = ile energii kinetycznej się rozprasza nie wraca do prędkości po odbiciu
