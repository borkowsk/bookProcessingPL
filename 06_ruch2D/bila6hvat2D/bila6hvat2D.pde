...
float h=0;
float x=0;
float vh=300; //prędkość w pikselach/SEKUNDĘ (!)
float vx=100;
float ah=-50; //Przyśpieszenie/hamowanie - tylko w pionie
float B=0.90; //Wydajność odbicia sprężystego 1-B = ile energii kinetycznej się rozprasza nie wraca do prędkości (odwrotnej)
