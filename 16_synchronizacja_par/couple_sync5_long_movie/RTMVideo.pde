...
//*
/// \note Apart from the "com.hamoid" library, you also need to install the ffmpeg program to make it work !!! 
...
static boolean     videoExportEnabled=false; ///< Has video making been initiated?
...
String copyrightNote="(c) A.Nowak & W.Borkowski @ ISS University of Warsaw";
